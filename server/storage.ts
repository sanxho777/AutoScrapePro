...
export class MemStorage implements IStorage {
  ...
  async createVehicle(insertVehicle: InsertVehicle): Promise<Vehicle> {
    ...
    const vehicle: Vehicle = {
      ...
      dealerName: insertVehicle.dealerName || null,
      dealerLocation: insertVehicle.dealerLocation || null,
      status: insertVehicle.status || "scraped",
      scrapedAt: new Date(),
      postedAt: null,
      lastUpdated: new Date(),
    };
  ...
  async createScrapingLog(insertLog: InsertScrapingLog): Promise<ScrapingLog> {
    ...
    const log: ScrapingLog = {
      ...insertLog,
      id,
      vehiclesFound: insertLog.vehiclesFound || null,
      vehiclesScraped: insertLog.vehiclesScraped || null,
